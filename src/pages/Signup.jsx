...
const Signup = ({ client, alert, setAlert, open, setOpen, severity, setSeverity }) => {
    ...
    <div>
      ...
      >
        <div className='auth-form-container'>
          ...
          <div>
            {showSignupAlert && <CustomAlert message={alert} open={open} setOpen={setOpen} severity={severity} />}
          </div>
